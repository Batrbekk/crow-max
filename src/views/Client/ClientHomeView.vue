<template>
  <div class="home-container">
    <sidebar-client-component active="1" class="fixed d-none-mob"/>
      ...
      <div class="main-container py-5 container flex-col">
        ...
        <div class="mb-5 flex main-dashboard-container justify-between ">
          <div class="mr-5 w-1/3 dashboard-container">
            <main-bar-dashboard :with-dashboard="true" type="activePrice" title="4 700 000 ₸" subtitle="Текущая задолжность" />
          </div>
          ...
          <div class="w-1/3 dashboard-container">
            <main-bar-dashboard :with-dashboard="false" type="date" title="580 000 ₸" subtitle="Ближайший платеж" />
          </div>
        </div>
...
import ProjectClientTable from '@/components/ProjectClientTable'
